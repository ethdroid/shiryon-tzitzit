...
2. Upload `index.html`, `styles.css`, `script.js`, and the `images/` folder to the repo root.
...
Drop your images into the `images/` folder with these exact names. Until a photo exists, the site shows a labeled dashed placeholder telling you what goes there.
